...
public class JedisPool extends Pool<Jedis> {
	...
	public JedisPool(final String host) {
		...
		if (uri.getScheme() != null && uri.getScheme().equals("redis")) {
			...
			this.internalPool = new GenericObjectPool(new JedisFactory(h, port, Protocol.DEFAULT_TIMEOUT, password, database), new Config());
		} else {
			this.internalPool = new GenericObjectPool(new JedisFactory(host, Protocol.DEFAULT_PORT, Protocol.DEFAULT_TIMEOUT, null, Protocol.DEFAULT_DATABASE), new Config());
		}
	}
